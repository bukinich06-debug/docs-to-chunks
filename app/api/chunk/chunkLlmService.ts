...
5. КОНТЕКСТ РАЗДЕЛА: если во фрагменте есть заголовки, разделы, вкладки, страницы, главы — в начале чанка кратко укажи, к чему он относится. Это нужно, чтобы при поиске по базе чанков было понятно, о какой части инструкции идёт речь, и не путать одинаковые названия из разных разделов.
